...
extension AutoSpotoConstants.URL {
    ...
    static var spotifyLogin: URL {
        ...
        guard let url = URL(string: "https://accounts.spotify.com/en/authorize?client_id=\(AutoSpotoConstants.Config.spotifyClientID)&response_type=code&redirect_uri=\(Self.redirectURI)&scope=playlist-modify-public%20playlist-modify-private%20ugc-image-upload&show_dialog=True&state=\(state)") else {
